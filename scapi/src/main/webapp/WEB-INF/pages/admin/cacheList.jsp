...
<body ng-controller="CacheListCtrl">
	...
	<table class="table table-striped">
		...
		<tr ng-repeat="item in cacheList">
			...
			<td><i class="fa fa-file" style="color:blue;cursor:pointer" ng-click="viewCacheElement(item['cacheName'])"></i> <i class="fa fa-times" style="color:red;cursor:pointer" ng-click="deleteCache(item['cacheName'])"></i></td>
		</tr>
	...
	<hr/>
		...
		<tr ng-repeat="item in cacheElementList">
			...
			<td> <i class="fa fa-times" style="color:red;cursor:pointer" ng-click="deleteCacheElement(item['cacheKey'])"></i></td>
		</tr>
